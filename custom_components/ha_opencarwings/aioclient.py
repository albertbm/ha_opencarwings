...
class RESTClientObject:
    ...
    def __init__(
        ...
        *,
        ...
        :param session: an existing aiohttp.ClientSession to reuse, such as
                        Home Assistant's shared one. The client then builds
                        no session of its own and close() leaves it open.
        """
